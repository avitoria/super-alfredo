...
public class InicioController extends HttpServlet {
	...
	private void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		// parametros
		String paramIdCategoria = (request.getParameter("idCategoria") == null) ? TODAS_LAS_CATEGORIAS
				: request.getParameter("idCategoria");
		String paramCatNom = (request.getParameter("categoria") == null) ? "Todas las Categorias"
